...
// running `pyverify serve` URL into the backend field to go live.
    ...
    <article className="page" style={{ maxWidth: "none" }}>
      <div style={{ maxWidth: "760px" }}>
        ...
        <p className="page-lede">
          This is the real pyverify dashboard. Here it renders a bundled sample report so you can
        ...
        <ul>
          ...
          <li>
            ...
            UI to live mode against your <code>pyverify serve</code>.
          </li>
        </ul>
        <div className="callout">
          <span className="callout-label">tip</span>
          <div>
            Run <code>uv run pyverify serve /path/to/project</code> locally, then paste its URL
